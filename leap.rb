...
#Leap years are years divisible by four (like 1984 and 2004). However, years divisible by 100 are not 
#leap years (such as 1800 and 1900) unless they are divisible by 400 (like 1600 and 2000, which were 
#in fact leap years).

puts 'Input a starting year (the lower number):'
start_year = gets.chomp
puts 'Input a higher ending year:'
end_year = gets.chomp
puts ''
